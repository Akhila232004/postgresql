...
ALTER TABLE employees.dept RENAME COLUMN department_name TO dname; 

-- Alter table "employees.emp": Add a new column called "hire_date" of type DATE.
ALTER TABLE employees.emp ADD COLUMN hire_date DATE; 
-- To change back to previous
...
ALTER TABLE employees.projects ALTER COLUMN budget TYPE DECIMAL(12,2); 
-- To change back to previous
ALTER TABLE employees.projects ALTER COLUMN budget TYPE NUMERIC(12,2); 

-- Alter table "employees.emp_rojects": Drop the column "end_date".
ALTER TABLE employees.emp_projects DROP COLUMN end_date; 
-- To change back to previous
ALTER TABLE employees.emp_projects ADD COLUMN end_date DATE; 